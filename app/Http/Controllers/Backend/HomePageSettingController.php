...
class HomePageSettingController extends Controller
{
    ...
    public function updatePopularCategorySection(Request $request)
    {
        ...
        $request->validate([
            ...
            'cat_one.required' => 'Caetegory one Field is required',
            'cat_two.required' => 'Caetegory two Field is required',
            'cat_three.required' => 'Caetegory three Field is required',
            'cat_four.required' => 'Caetegory four Field is required'
        ]);
    ...
    public function updateProductSliderSectionOne(Request $request)
    {
        $request->validate([
            ...
            'cat_one.required' => 'Caetegory Field is required'
        ]);
