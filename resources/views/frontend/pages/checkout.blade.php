                    ...
                    <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            @if ($method->type == 'min_cost' && getCartTotal() >= $method->min_cost)
                                <div class="form-check">
                                    <input class="form-check-input shipping_method" type="radio" name="exampleRadios"
                                        id="exampleRadios1" value="{{ $method->id }}" data-cost="{{ $method->cost }}">
                        ...
                        <div class="wsus__order_details_summery">
                            ...
                            <p><b>total:</b> <span><b id="total_amount"
                                        data-total-amount="{{ getMainCartTotal() }}">{{ $settings->currency_icon }}{{ getMainCartTotal() }}</b></span>
                            </p>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.shipping_method').on('click', function() {
                ...
                let curentTotalAmout = $('#total_amount').data('total-amount')
                let totalAmount = curentTotalAmout + shippingFee;
